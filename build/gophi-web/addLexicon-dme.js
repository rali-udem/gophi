// adapted from https://codepen.io/KryptoniteDove/post/load-json-file-locally-using-pure-javascript
...
loadJSON("gophi-web/lexicon-dme.json",function(response) {
  // Parse JSON string into object
    var dmeLexicon = JSON.parse(response);
